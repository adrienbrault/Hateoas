...
{
    /**
     * @dataProvider getHateoasGroupsData
     */
    public function testSerialize(array $groups)
    {
        ...
        $this
            ->string($this->hateoas->serialize($collection, 'xml', $this->createContextWithGroups($groups)))
            ->isEqualTo(
                <<<XML
